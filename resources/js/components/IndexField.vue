<template>
    <span>
        <a href="javascript:;" @click.prevent="reorderResource('up')" class="cursor-pointer text-70 hover:text-primary mr-3">
        ...
        <a href="javascript:;" @click.prevent="reorderResource('down')" class="cursor-pointer text-70 hover:text-primary">
